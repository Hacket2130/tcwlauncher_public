...
- `downloads/TCWA3-Launcher-Setup-0.3.6-beta.exe`: current public Windows setup installer.
- `downloads/TCW-Launcher-Windows-0.3.6-beta.zip`: current public Windows launcher package backup.
- `downloads/TCWA3-Website-0.3.6-beta.zip`: current public website static-file package backup.
...
1. Download `downloads/TCWA3-Launcher-Setup-0.3.6-beta.exe`.
