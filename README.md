...
```text
https://tcwa3.co.uk/
https://tcwa3.co.uk/downloads/TCWA3-Launcher-Setup-0.4.0-beta.exe
```

## Current Files

- `downloads/TCWA3-Launcher-Setup-0.4.0-beta.exe`: current public Windows setup installer.
- `downloads/TCW-Launcher-Windows-0.4.0-beta.zip`: current public Windows launcher package backup.
- `downloads/TCW-Launcher-Linux-0.4.0-beta.zip`: current public Linux launcher package backup.
- `downloads/TCWA3-Website-0.4.0-beta.zip`: current public website static-file package backup.
- `downloads/TCWA3-Backend-0.4.0-beta.zip`: current public backend package backup.
...
1. Download `downloads/TCWA3-Launcher-Setup-0.4.0-beta.exe`.
